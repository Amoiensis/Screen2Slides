...
- 当前线上地址主要用于功能体验和快速测试
- 由于线上资源有限，上传与处理的文件大小做了限制
- 如需更稳定、更充足的线上资源支持，或希望进一步交流和讨论，可加入 QQ 群: `1097740457`

会议录屏、课程录屏和演示视频通常会涉及版权、隐私或内部资料。项目也支持自主本地部署，视频、截图和导出结果都可在本地环境完成处理，不必上传到第三方服务，数据安全更可控。
